...
{
    //   Define a max value
    protected const int max_hobbies = 60;
...
internal class HobbyGenerator: Context
{

    //   Initialize a Data Structure called hobby within the class
    private List<string> hobbies = [];

    public static void RunHobbies(string uname)
    {
    ...
    private static void InteractiveHobbyGenerator(string uname)
    {
        ...
        if (answer == "yes" || answer == "ye" || answer == "y")
        {
            ...
            while (i < max_hobbies)
            {
                ...
                string hobby = RandomArrayGenerator();
...
internal class Conditions: Context
{
